...
export default class MpaInfo extends React.Component {
	render() {
		return (
			<svg width="65%" viewBox="0 -30 1020 720">
      <g id="map" visibility="visible" fill="none" strokeWidth={3}>
        <g id="Seas" fill="none">
        ...
        <g class="circulosI">
          <g class="Europa_c">
            <svg id="circulo_1">
                <circle class="circuloI" cx="500" cy="200" r="25"/>
                <text x="500" y="200">+5</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_1">
                  <rect class="rectanguloInfo" x="455" y="230" rx="20" ry="20" width="90" height="40"/> 
                  <text x="500" y="250">Europa</text>                
              </svg>
            </g>
          </g>
          <g class="Asia_c">
            <svg id="circulo_2">
                <circle class="circuloI" cx="750" cy="220" r="25"/>
                <text x="750" y="220">+7</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_2">
                  <rect class="rectanguloInfo" x="715" y="250" rx="20" ry="20" width="70" height="40"/> 
                  <text x="750" y="270">Asia</text>                
              </svg>
            </g>
          </g>
          <g class="Africa_c">
            <svg id="circulo_3">
                <circle class="circuloI" cx="525" cy="440" r="25"/>
                <text x="525" y="440">+3</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_3">
                  <rect class="rectanguloInfo" x="485" y="470" rx="20" ry="20" width="80" height="40"/> 
                  <text x="525" y="490">África</text>                
              </svg>
            </g>
          </g>
          <g class="Oceania_c">
            <svg id="circulo_4">
                <circle class="circuloI" cx="850" cy="500" r="25"/>
                <text x="850" y="500">+2</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_4">
          ...
          <g class="AmericaSur_c">
            <svg id="circulo_5">
                <circle class="circuloI" cx="280" cy="440" r="25"/>
                <text x="280" y="440">+2</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_5">
                  <rect class="rectanguloInfo" x="215" y="470" rx="20" ry="20" width="130" height="40"/> 
                  <text x="280" y="490">Sudamérica</text>                
              </svg>
            </g>
          </g>
          <g class="AmericaNorte_c">
            <svg id="circulo_6">
                <circle class="circuloI" cx="220" cy="210" r="25"/>
                <text x="220" y="210">+5</text>
            </svg>
            <g class="text_info">
              <svg id="circulo_6">
                  <rect class="rectanguloInfo" x="125" y="240" rx="20" ry="20" width="190" height="40"/> 
                  <text x="220" y="260">América del Norte</text>                
              </svg>
            </g>
          </g>
        </g>
